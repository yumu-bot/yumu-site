...
<template>
	...
	disableOnInteraction: false
			...
			<swiper-slide><img src="/img/swiper/Banner_1.jpg" alt="" /></swiper-slide>
			<swiper-slide><img src="/img/swiper/Banner_2.jpg" alt="" /></swiper-slide>
			<swiper-slide><img src="/img/swiper/Banner_3.jpg" alt="" /></swiper-slide>
		</swiper>
	</div>
</template>
